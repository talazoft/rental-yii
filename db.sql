...
DROP SCHEMA IF EXISTS `sstig_contact_us_arjintas` ;
...
CREATE  TABLE IF NOT EXISTS `sstig_contact_us_arjintas`.`rd_application_information` (
  ...
  `num_of_applicant` TINYINT(2) NOT NULL ,
  ...
  `anticipated_date` VARCHAR(11) NOT NULL ,
  `refered_lead` TINYINT(1) NOT NULL ,
  ...
  `prime_applic_cellphone` VARCHAR(25) NOT NULL ,
  `prime_applic_homephone` VARCHAR(25) NULL ,
  `prime_applic_email` VARCHAR(150) NOT NULL ,
...
CREATE  TABLE IF NOT EXISTS `sstig_contact_us_arjintas`.`rd_applicant_info` (
  ...
  `has_pet` VARCHAR(45) NULL ,
  `pet_num` SMALLINT NULL ,
...
CREATE  TABLE IF NOT EXISTS `sstig_contact_us_arjintas`.`rd_residental_history` (
  ...
  `year_month_moved_in` VARCHAR(150) NOT NULL ,
  `agent_landlord_type` VARCHAR(45) NOT NULL ,
