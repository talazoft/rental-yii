...
/**
 * This is the model class for table "{{personal_refrence}}".
 *
 * The followings are the available columns in table '{{personal_refrence}}':
 * @property integer $id
 ...
 */
class PersonalRefrence extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return PersonalRefrence the static model class
	 */
