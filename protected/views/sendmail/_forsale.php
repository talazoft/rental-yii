        ...
        <div class="maincontent_info">
            ...
            <div class="content">
                ...
                <div class="formulir">
                    <table width="100%">
                        <tr>
                            <td width="25%"> Today's Date :</td>
                            <td width="40%"> Property Name :</td>
                            <td width="35%"> Unit #   :</td>
                        </tr>
                        <tr>
                            <td colspan="2"> Applicant's Work Number :</td>
                            <td width="35%"> Applicant's Home Number :</td>            
                        </tr>
                        <tr>
                            <td colspan="2"> Applicant's Cellphone Number :</td>
                            <td width="35%"> Applicant's Email Address :</td>            
                        </tr>
                    </table>
                </div>
                <div class="formulir">
                ...
                <div class="formulir1">
                    <table width="100%" >
                        <tr>
                            ...
                            <td width="33%"> Middle :</td>     
                            <td width="34%"> Last :</td>        
                        </tr>
                        <tr>
                            <td> Date of Birth :</td>
                            <td> Driver Lisence No :</td>     
                            <td> S.S.No :</td>        
                        </tr>
                    </table>
                </div>
                <div class="formulir2">
                    <table width="100%" >
                        ...
                        <tr>
                            ...
                            <td width="25%">One years ?</td>   
                            <td width="25%">Two years ? </td>
                            <td width="25%">Three years ?</td> 
                        </tr>
                        <tr>
                ...
                <div class="formulir3">
                    ...
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td>Land Lord's Name :</td> 
                            <td>Phone No. :</td> 
                        </tr>
                        <tr>
                            <td colspan="4"><div class="panjang">Reason for Moving :</div></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="4"><div class="panjang"><i>Reason for Moving</i> :</div></td>
                        </tr>
                    </table>
                </div>
                <br>
                ...
                <table width="100%">
                    <tr>
                        <td>Employed by :</td>
                        <td colspan="2"><div class="panjang">Address : </div></td> 
                    </tr>
                    <tr>
                        <td width="45%">Phone No : </td>
                        <td width="25%">Department : </td> 
                        <td width="35%">Position / Title :</td> 
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>Length of Stay in Current Location : </td> 
                ...
                <table width="100%">
                    <tr>
                        <td width="33%"><div class="nofloat">Name : &nbsp;</div></td> 
                        <td width="33%"><div class="nofloat">Relation : &nbsp;</div></td> 
                        <td width="34%"><div class="nofloat">Address : &nbsp;</div></td> 
                        <td width="34%"><div class="nofloat">Phone No : &nbsp;</div></td>
                    </tr> 
                    <tr>
                        <td width="33%"><div class="nofloat">Name : &nbsp;</div></td> 
                        <td width="33%"><div class="nofloat">Relation : &nbsp;</div></td> 
